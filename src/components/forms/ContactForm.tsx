      ...
      <div className="max-w-7xl mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-16">
          <FadeIn direction="left">
            ...
            <h2 className="text-3xl md:text-5xl font-heading font-bold">Questions About Your Spray Foam?</h2>
            <p className="mt-4 text-lg text-muted-foreground leading-relaxed">
              Send a question about anything covered on this site. Want an honest read on your
              specific situation instead? Use our{" "}
              <a href="/get-a-second-opinion" className="text-primary underline underline-offset-2">
