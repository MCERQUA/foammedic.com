...
const companyLinks = [
  ...
  { label: "Get a Second Opinion", href: "/get-a-second-opinion" },
];
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 md:gap-8">
          <div className="lg:col-span-1">
            ...
            <p className="mt-4 text-sm text-ink-foreground/70 leading-relaxed max-w-xs">
              An honest diagnostic resource for people who suspect a spray foam insulation
              problem — what&apos;s normal, what isn&apos;t, and what actually gets fixed.
