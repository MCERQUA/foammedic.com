...
const stats = [
  { value: "6", label: "Symptom & Diagnosis Guides Covered in Depth" },
  { value: "0", label: "Fabricated Case Studies or Scare Tactics" },
  { value: "20+", label: "Years of Combined Contractor-Side Experience" },
  { value: "100%", label: "Free, No-Obligation Second Opinions" },
];
