...
export function CTA({
  ...
  description = "Get a free, honest second opinion on your spray foam situation — no pressure, no obligation, and no incentive to tell you it's worse than it is.",
  primaryCTA = "Get a Second Opinion",
  primaryHref = "/get-a-second-opinion",
}: CTAProps) {
  return (
