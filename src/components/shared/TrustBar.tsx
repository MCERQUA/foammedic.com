import { ClipboardCheck, ShieldCheck, FileCheck, BadgeCheck } from "lucide-react";

const items = [
  { icon: ClipboardCheck, label: "Diagnosis First, Never a Sales Pitch" },
  { icon: ShieldCheck, label: "Backed by 20+ Years Contractor Experience" },
  { icon: FileCheck, label: "Grounded in Real Chemistry, Not Fear" },
  { icon: BadgeCheck, label: "Free Second Opinion, No Obligation" },
];
