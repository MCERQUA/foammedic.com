...
export const metadata: Metadata = {
  title: "Blog",
  description: "Deeper dives on spray foam litigation, documentation, inspections, and telling real problems apart from normal cure characteristics.",
};
        ...
        <div className="max-w-4xl mx-auto px-4 md:px-6 text-center">
          <FadeIn>
            ...
            <p className="mt-4 text-lg text-muted-foreground">
              Specific, honest answers to the questions our main topic pages don&apos;t fully cover.
            </p>
          </FadeIn>
        </div>
      </section>
