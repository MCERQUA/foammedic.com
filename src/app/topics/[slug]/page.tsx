    ...
    <main>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 md:px-6 pt-36 pb-16 md:pt-48 md:pb-20 text-center">
          <p className="text-sm font-semibold text-accent uppercase tracking-wider mb-3">Spray Foam Diagnosis</p>
      ...
      <FAQ
        ...
        subtitle="Real questions people ask when they suspect a spray foam problem."
        faqs={content.faqs}
      />
